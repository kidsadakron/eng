 ...
 <script>
  ...
  <body>
	...
	case "study":
		...
		case "13":
                    $_SESSION["eln_unit"] = 13;
			if(checkRoom(13) == 0){
				
				include("perTestLesson.php");
			}else if (checkRoom(13) == 2) {
		...
		case "14":
                    $_SESSION["eln_unit"] = 14;
			if(checkRoom(14) == 0){
				
				include("perTestLesson.php");
			}else if (checkRoom(14) == 2) {
		...
		case "15":
                    $_SESSION["eln_unit"] = 15;
			if(checkRoom(15) == 0){
				
				include("perTestLesson.php");
			}else if (checkRoom(15) == 2) {
			...
			break;
		case "16":
                    $_SESSION["eln_unit"] = 16;
			if(checkRoom(16) == 0){
				
				include("perTestLesson.php");
			}else if (checkRoom(16) == 2) {
	...
	function checkRoom($unit){
		...
		$strSQL = "SELECT * FROM `eln`.`study` WHERE `id_number` = '".$id_number."' AND unit_id = ".$unit."";
		...
		mysql_select_db("eln");
			...
			$id_number = $data[0]['id_number'];
		$strSQL = "SELECT * FROM `eln`.`study` WHERE `id_number` = '".$id_number."' AND unit_id = ".$unit." AND status = 2";
