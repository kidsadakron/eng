...
mysql_query("SET NAMES utf8");
 $strSQL = "UPDATE `work_answer` SET `work_answer_content` = '".$content."' WHERE `work_answer`.`unit_id` = '".$unit_id."' AND `work_answer`.`work_id` = '".$work_id."' AND `work_answer`.`id_number` = '".$id_number."';";
