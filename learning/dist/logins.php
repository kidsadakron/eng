...
$strSQL = "SELECT `id_number`,`pname`,`fname`,`lname`,`role`,`email`,`phone` FROM `user` WHERE (`email` = '".$email."' OR id_number = '".$email."') AND `password` = '".$pass."' ";
   mysql_query("SET NAMES utf8");
