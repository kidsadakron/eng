 ...
 <script>
	...
	$(document).ready(function(){
        ...
        function refresh(){
            ...
            // window.location.href = 'dist/updateStudy.php?status=3';
	...
	function selectQuestion(unit , question_number,isPervade) {
		var data = {unit:unit,
...
<div style="height: 75px;display: table;  width: 100%; ">
    <span style="display: table-cell;    vertical-align: middle;color: red;"><h1 class='topic'>วิชาเครือข่ายคอมพิวเตอร์และอินเทอร์เน็ต </h1> </span>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><h1 style="text-align: center;color: red;" >แบบทดสอบหลังเรียน<span class="topic"></span></h1></h4>
      </div>
      <div class="modal-body">
      
		 <div>
            
            <h1 style="font-size: 60px;text-align: center;">ได้คะแนน <span id="score-text"></span> / เต็ม 10</h1>
        </div>
      </div>
