...
<div class="row">
        ...
        switch ($_GET["page"]) {
            case "webboard":
                $_SESSION["bpage"] = $_GET["bpage"];
                 include("app/View/webboard.php");
                 break;
            case "chats":
             ...
             case "test":
                 ...
                 if (checkRoom(0) == 1 && checkRoom(4) == 1) {
                    include("app/view/postTestRoom.php");
                }else{
                     include("app/View/lesson_list.php");
                }
                break;
	case "lesson":
            switch ($_GET["unit"]) {	
            ...
            default:
                $_SESSION["eln_unit"] = 0;
                if(checkRoom(0) == 0){
                    include("app/view/perTestRoom.php");
		}else{
                    include("app/View/lesson_list.php");
		}
		break;
		...
		include 'app/View/login.php';
                 ...
                 include 'app/View/updateName.php';
            }
         break;       
        }   
          ?>
