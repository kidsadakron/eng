...
<div style="height: 75px;display: table;  width: 100%; ">
    <span style="display: table-cell;    vertical-align: middle;color: red;"><h1>แบบทดสอบก่อนเรียน</h1> </span>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><h1 style="text-align: center;color: red;">แบบทดสอบก่อนเรียน</h1></h4>
      </div>
