 ...
 include("../../config.php");
            ...
            if(mysql_num_rows($objQuery) > 0){
                echo '<a href="index.php?page=lesson&unit=1">หน่วยที่ 1 Personal Pronouns</a>';
            }else{
            ...
            $objQuery = mysql_query($strSQL);
            if(mysql_num_rows($objQuery) > 0){
                echo '<a href="index.php?page=lesson&unit=2">หน่วยที่ 2 Possessive Pronouns and Reflexive Pronouns</a>';
            }else{
            ...
            if(mysql_num_rows($objQuery) > 0){
                echo '<a href="index.php?page=lesson&unit=3">หน่วยที่ 3 Indefinite Pronouns</a>';
            }else{
            ...
            $objQuery = mysql_query($strSQL);
            if(mysql_num_rows($objQuery) > 0){
                echo '<a href="index.php?page=lesson&unit=4">หน่วยที่ 4 Demonstrative Pronouns</a>';
            }else{
            ...
            if(mysql_num_rows($objQuery) > 0){
                 ...
                 echo '  <a style="width: 49%;" href="index.php?page=test"  class="btn btn-lg btn-primary">แบบฝึกหัดท้ายบท</a>';
            }else{
